...
btnAgregar.addEventListener('click', (e) => {
    e.preventDefault();
    alerta.innerHTML = "";
    (regexNombre.exec(nombre.value)) ? valid(0): invalid(0, `Nombre inválido, por favor vuelva a intentarlo.`);
    (regexContra.exec(contra.value)) ? valid(1): invalid(1, `Contraseña, inválido, por favor vuelva a intentarlo.`);
